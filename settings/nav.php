 <nav class="navbar navbar-expand-lg bg-light">
              ...
              <div class="container-fluid">
                  <a class="navbar-brand" href="#"><i class="bi bi-activity"></i> Config</a>
...
?>
                <li class="nav-item"></li> 
                    <a class="nav-link active text-capitalize" aria-current="page" href="#" onClick="linkAction ('<?=$KII?>.php','','alpha','search')"><i class="bi bi-archive"></i> <?=$VII?></a>
                </li>
                <? }?>
